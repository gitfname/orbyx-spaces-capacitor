...
function FolderCard1({ className, size, lastUpdateTime, name, colorSchema, ...props }: Props) {
    return (
        <button
            {...props}
        ...
        >
            ...
            <div className="w-12 h-12 rounded-full grid place-items-center absolute translate-y-[30%] translate-x-[30%] shadow-md shadow-black/10 -top-6 left-0 bg-accent-red">
                <img
                    alt=""
...

            {
                colorSchema === "dark"
                    ...
                    <img
                        ...
                        className="row-start-1 row-end-1 col-start-1 col-end-1"
                    />
                    :
                    <img
                        alt=""
            ...
            >
                ...
                <Text size="subtitle2" className={`text-end ${colorSchema === "dark" ? "text-brand-3" : ""}`}>{size}</Text>
